                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="carousel-content centered">
                                    <h2 class="boxed animation animated-item-1">Crea tu cuenta GRATIS con nosotros</h2>
                                    <p class="animation animated-item-2">Regístrate pronto, con tu cuenta puedes empezar a apostar de manera rápida y muy fácil</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="item" style="background-image: url(images/slider/bg3.jpg)">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="carousel-content centered">
                                    <h2 class="boxed animation animated-item-1">Los mejores LOGROS y variedad de APUESTAS</h2>
