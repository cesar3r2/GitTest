<?php
	...
	// set few params
	$grid["caption"] = "Logros Básquetbol";
	$grid["rowNum"] = 15;
	...
	$g->select_command = "SELECT id, encuentro, favorito, 
       ...
       altabaja1, altabaja2, v_altabaja, ganadorm1, ganadorm2, runlinem1, runlinem2, v_runline_m,
       altabajam1, altabajam2, v_altabaja_m, estatus FROM logro_basquetbol WHERE fecha='".date('Y-m-d')."'"; 
	
	// set database table for CRUD operations
	$g->table = "logro_basquetbol";
...
<html>
  <head>
    <title>Parley360 - Logros Básquetbol</title>
  ...
  <body>
    ...
    <div align="center" style="color: #2B58A5; font-size:14px; margin-bottom: 20px"><strong>Logros Básquetbol</strong> | <?php echo fecha_letras();?></div>
    <div align="center" style="margin-bottom: 50px"><?php echo $out?></div>
    <div align="center" style="margin-bottom: 20px">
        <FIELDSET>
            <form name="formu" enctype="multipart/form-data" method="post" id="formu" action="upload.php?accion=basquetbol"/>
