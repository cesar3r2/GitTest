<?php
	...
	$g->select_command = "SELECT id, encuentro, equipo1, equipo2, favorito, 
       hora, ganador1, ganador2, estatus FROM logro_boxeo WHERE fecha='".date('Y-m-d')."'"; 
...
<html>
  <head>
    <title>Parley360 - Logros Boxeo</title>
  ...
  <body>
    ...
    <div align="center" style="color: #2B58A5; font-size:14px; margin-bottom: 20px"><strong>Logros Boxeo</strong> | <?php echo fecha_letras();?></div>
    <div align="center" style="margin-bottom: 50px"><?php echo $out?></div>
    <div align="center" style="margin-bottom: 20px">
        <FIELDSET>
            <form name="formu" enctype="multipart/form-data" method="post" id="formu" action="upload.php?accion=boxeo"/>
