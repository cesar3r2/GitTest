<?php
	...
	$g->select_command = "SELECT id, encuentro, favorito, 
       ...
       altabaja1, altabaja2, v_altabaja, estatus FROM logro_hockey WHERE fecha='".date('Y-m-d')."'"; 
	
	// set database table for CRUD operations
	$g->table = "logro_hockey";
...
<html>
  <head>
    <title>Parley360 - Logros Hockey</title>
  ...
  <body>
    ...
    <div align="center" style="color: #2B58A5; font-size:14px; margin-bottom: 20px"><strong>Logros Hockey</strong> | <?php echo fecha_letras();?></div>
    <div align="center" style="margin-bottom: 50px"><?php echo $out?></div>
    <div align="center" style="margin-bottom: 20px">
        <FIELDSET>
            <form name="formu" enctype="multipart/form-data" method="post" id="formu" action="upload.php?accion=hockey"/>
