<?php
	...
	$g->select_command = "SELECT id, encuentro, favorito, 
       ...
       altabaja1, altabaja2, v_altabaja, estatus FROM logro_futbol WHERE fecha='".date('Y-m-d')."'"; 
	
	// set database table for CRUD operations
	$g->table = "logro_futbol";
...
<html>
  <head>
    <title>Parley360 - Logros Fútbol</title>
  ...
  <body>
    ...
    <div align="center" style="color: #2B58A5; font-size:14px; margin-bottom: 20px"><strong>Logros Fútbol</strong> | <?php echo fecha_letras();?></div>
    <div align="center" style="margin-bottom: 50px"><?php echo $out?></div>
    <div align="center" style="margin-bottom: 20px">
        <FIELDSET>
            <form name="formu" enctype="multipart/form-data" method="post" id="formu" action="upload.php?accion=futbol"/>
