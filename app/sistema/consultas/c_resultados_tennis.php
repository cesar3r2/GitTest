...
<TABLE  align="left" width="100%" border="0" cellpadding="1" cellspacing="1">
   	<TR><TD align="center" colspan="4"><FONT style="color : #2B58A5; font-size:14px"><strong>Resultados de Tennis para el <?php echo fecha($fecha); ?></strong></FONT></TD></TR>
</TABLE>
<?php 
if ($totObj == 0) { ?>
...
<TABLE align="left" width="100%" border="0" cellpadding="1" cellspacing="1">
	...
	<?php
	$objeto = new resultado_tennis();
	$fObj1 = $objeto->consultas_resultados_diarios_encuentros($fObj[$j]['id_liga'], $fecha);
	$totObj1 = count($fObj1);
	
	if ($totObj1 == 0) { ?>
	<TR bgcolor="#F3F3F3">
		<TD colspan='4' align="center" style="color:#F00">No existen resultados registrados para este torneo</TD>
	</TR>
	<?php 
	} else {
