...
<TABLE style="width: 100%;">
	<TR>
        ...
        <TD style="width: 70%;" align="right"><FONT style="font-weight:bold; font-size:15px">Logros de Hockey para el <?php echo fecha($fecha); ?></FONT></TD>
    </TR>
</TABLE>
<br><br>
<?php if ($totObj == 0) { ?>
...
<?php
    ...
    try
    {
		...
		$fec = split('/', $fecha);
		$nombre_arc = 'logrosHockey'.$fec[0].$fec[1].$fec[2];
