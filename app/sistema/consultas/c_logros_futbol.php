<?php
	...
	$totObj = count($fObj);
?>
<?php barra_opciones3("", "window.open('sistema/consultas/pdf_logros_futbol.php?fecha=$fecha')", "cambiar_contenido('sistema/consultas/logros_diarios.php', 'sub_contenido')");?>
<DIV id="impresion">
<TABLE align="left" width="100%" border="0" cellpadding="1" cellspacing="1">
	<TR><TD align="center" colspan="9"><FONT style="font-weight:bold; color : #2B58A5; font-size:14px"><strong>Logros de Fútbol para el <?php echo fecha($fecha); ?></strong></FONT></TD></TR>
</TABLE>
<?php
if ($totObj == 0){?>
...
<TABLE align="left" width="100%" border="0" cellpadding="1" cellspacing="1">
	<THEAD>
    <TR bgcolor="#6FA144"><TD colspan="9" style="text-align:center;"><FONT style="font-weight:bold; color: #FFF;"><?php echo $fObj[$j]['nombre']; ?></FONT></TD></TR>
	<TR bgcolor="#328AA4" height="25">
        ...
        <TD width="17%" align="center" style="color: #FFFFFF"><strong>Ganar</strong></TD>
        <TD width="15%" align="center" style="color: #FFFFFF"><strong>Empate</strong></TD>
        <TD width="17%" align="center" style="color: #FFFFFF"><strong>RunLine</strong></TD>
        <TD width="17%" align="center" style="color: #FFFFFF"><strong>AltaBaja</strong></TD>
	</TR>
	</THEAD>
	<?php
	...
	<TR bgcolor="<?php echo $color;?>">
        ...
        <TD align="center"><?php echo $fObj1[$i]['empate']; ?></TD>
        <TD align="center">
			<?php if ($fObj1[$i]['v_runline']!=-1) echo $signo1.$fObj1[$i]['v_runline'].' ('.$fObj1[$i]['runline1'].')<br><br>'.$signo2.$fObj1[$i]['v_runline'].' ('.$fObj1[$i]['runline2'].')'; ?>
        </TD>
        <TD align="center">
