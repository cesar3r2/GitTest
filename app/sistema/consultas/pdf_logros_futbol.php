...
<TABLE style="width: 100%;">
	<TR>
        ...
        <TD style="width: 70%;" align="right"><FONT style="font-weight:bold; font-size:15px">Logros de Fútbol para el <?php echo fecha($fecha); ?></FONT></TD>
    </TR>
</TABLE>
<br><br>
<?php if ($totObj == 0) { ?>
...
<TABLE style="width: 100%; font-size:12px;" align="center" border="0" cellpadding="0" cellspacing="0">
    <TR><TD colspan="6" style="text-align:center;"><FONT style="font-weight:bold; color: #2B58A5; font-size:13px"><?php echo $fObj[$j]['nombre']; ?></FONT></TD></TR>
	<TR bgcolor="#CCCCCC">
		<TD style="width: 22%;" align="center" class="textoSM"><strong>Encuentro</strong></TD>
        <TD style="width: 12%;" align="center" class="textoSM"><strong>Hora</strong></TD>
        <TD style="width: 17%;" align="center" class="textoSM"><strong>Ganar</strong></TD>
        <TD style="width: 15%;" align="center" class="textoSM"><strong>Empate</strong></TD>
        <TD style="width: 17%;" align="center" class="textoSM"><strong>RunLine</strong></TD>
        <TD style="width: 17%;" align="center" class="textoSM"><strong>AltaBaja</strong></TD>
	</TR>
	<?php 
	...
	<TR class="textoSM" bgcolor="<?php echo $color; ?>">
        ...
        <TD class="tdLine" align="center"><?php echo $fObj1[$i]['empate']; ?></TD>
        <TD class="tdLine" align="center"><?php if ($fObj1[$i]['v_runline']!=-1) echo $signo1.$fObj1[$i]['v_runline'].' ('.$fObj1[$i]['runline1'].')<br><br>'.$signo2.$fObj1[$i]['v_runline'].' ('.$fObj1[$i]['runline2'].')'; ?></TD>
...
<?php
    ...
    try
    {
		...
		$fec = split('/', $fecha);
		$nombre_arc = 'logrosFutbol'.$fec[0].$fec[1].$fec[2];
