...
<TABLE  align="left" width="100%" border="0" cellpadding="1" cellspacing="1">
   	<TR><TD align="center" colspan="4"><FONT style="color: #2B58A5; font-size:14px"><strong>Resultados de Boxeo para el <?php echo fecha($fecha); ?></strong></FONT></TD></TR>
</TABLE>
<?php 
if ($totObj == 0) { ?>
...
<TABLE align="left" width="100%" border="0" cellpadding="1" cellspacing="1">
	...
	<TR bgcolor="#328AA4" height="20">
		<TD width="25%" align="center" style="color: #FFFFFF"><strong>Pelea</strong></TD>
        <TD width="25%" align="center" style="color: #FFFFFF"><strong>Ganador</strong></TD>
        <TD width="25%" align="center" style="color: #FFFFFF"><strong>Marcador</strong></TD>
        <TD width="25%" align="center" style="color: #FFFFFF"><strong>Estatus</strong></TD>
	</TR>
	</THEAD>
	<?php
	$objeto = new resultado_boxeo();
	$fObj1 = $objeto->consultas_resultados_diarios_encuentros($fObj[$j]['id_liga'], $fecha);
	$totObj1 = count($fObj1);
	
	if ($totObj1 == 0) { ?>
	<TR bgcolor="#F3F3F3">
		<TD colspan='4' align="center" style="color:#F00">No existen resultados registrados para esta liga</TD>
	</TR>
	<?php 
	} else {
