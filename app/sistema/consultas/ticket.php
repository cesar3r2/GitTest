...
<TABLE align="left" width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <TR>
		<TD align="right">
			<?php barra_opciones2('', "cambiar_contenido('sistema/consultas/ticket.php', 'sub_contenido')");?>
		</TD>
	</TR>
</TABLE>
...
<TABLE align="left" width="100%" border="0" cellpadding="2" cellspacing="1">
	<TR>
		<TD width="20%" class="titForm" align="right"><FONT class="txt-rojo">*&nbsp;</FONT>Nro. Ticket&nbsp;</TD>
	...
	<TR>
		...
		<TD class="objForm"><INPUT type="text" name="nro_seguridad" id="nro_seguridad" size="15" maxlength="10" onKeyPress="buscarInfoEnterVerTicket(event, 'mostrarTicket'); return soloNumeros(event);" >&nbsp;&nbsp;<img src="imagenes/seleccionar.png" border="0" style="cursor:pointer" title="Click para mostrar ticket" onclick="mostrarTicketConsulta();"></TD>
	</TR>
    <TR height="30px">
