...
<TABLE style="width: 100%;">
	<TR>
        ...
        <TD style="width: 70%;" align="right"><FONT style="font-weight:bold; font-size:15px">Logros de Fútbol Americano para el <?php echo fecha($fecha); ?></FONT></TD>
    </TR>
</TABLE>
<br><br>
<?php if ($totObj == 0) { ?>
...
<TABLE style="width: 100%; font-size:12px;" align="center" border="0" cellpadding="0" cellspacing="0">
    <TR><TD colspan="5" style="text-align:center;"><FONT style="font-weight:bold; color: #2B58A5; font-size:13px"><?php echo $fObj[$j]['nombre']; ?></FONT></TD></TR>
	<TR bgcolor="#CCCCCC">
		<TD style="width: 25%;" align="center" class="textoSM"><strong>Encuentro</strong></TD>
        <TD style="width: 15%;" align="center" class="textoSM"><strong>Hora</strong></TD>
        <TD style="width: 20%;" align="center" class="textoSM"><strong>Ganar</strong></TD>
        <TD style="width: 20%;" align="center" class="textoSM"><strong>RunLine</strong></TD>
        <TD style="width: 20%;" align="center" class="textoSM"><strong>AltaBaja</strong></TD>
	</TR>
	<?php 
...
<?php
    ...
    try
    {
		...
		$fec = split('/', $fecha);
		$nombre_arc = 'logrosFutbolAmericano'.$fec[0].$fec[1].$fec[2];
