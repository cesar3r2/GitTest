...
<TABLE align="left" width="100%" border="0" cellpadding="0" cellspacing="0">
	<TR>
		...
		<TD width="50%" align="right">
			<?php barra_opciones2('anularTicket()', "cambiar_contenido('sistema/procesos/anular_ticket.php', 'sub_contenido')");?>
		</TD>
	</TR>
</TABLE>
...
<TABLE align="left" width="100%" border="0" cellpadding="2" cellspacing="1">
	...
	<TR>
		...
		<TD class="objForm"><INPUT type="text" name="nro_seguridad" id="nro_seguridad" size="15" maxlength="10" onKeyPress="buscarInfoEnterAnuTicket(event, 'mostrarTicketAnu'); return soloNumeros(event);">&nbsp;&nbsp;<img src="imagenes/seleccionar.png" border="0" style="cursor:pointer" title="Click para mostrar ticket" onclick="mostrarTicket();">
