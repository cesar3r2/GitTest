<?php
	...
	$titulo = 'Cargar Resultados | Fútbol';
	$fActual = date("Y-m-d");
...
<TABLE align="left" width="100%" border="0" cellpadding="0" cellspacing="0">
	<TR>
        ...
        <TD width="50%" align="right">
			<?php barra_opciones2('guardarResultadosFutbol()', "cambiar_contenido('sistema/procesos/cargar_resultados.php', 'sub_contenido')");?>
		</TD>
	</TR>
</TABLE>
...
<TABLE align="left" width="100%" border="0" cellpadding="2" cellspacing="1" style="border-color:#CCC; border-width:1px; border-style:solid">
	...
	<TR>
		...
		<TD class="objForm">
        	<SELECT id="fecha" onchange="cargarEncuentrosFutbol()">
	...
	<TR>
        ...
        <TD class="objForm">
        	<SELECT id="sel_encuentro" onchange="datosEncuentroFutbol()">
            	<OPTION value="0">Seleccione..</OPTION>
            </SELECT>
        </TD>
	</TR>
    ...
    <TR>
        ...
        <TD class="titForm">
        	<INPUT onKeyPress="return soloNumeros(event);" onblur="javascript: calcularMarcador('tot_goles');" type="text" value="0" id="marcador1" size="2" maxlength="2" onchange="calculaResFutbol();"> x 
            <INPUT onKeyPress="return soloNumeros(event);" onblur="javascript: calcularMarcador('tot_goles');" type="text" value="0" id="marcador2" size="2" maxlength="2" onchange="calculaResFutbol();">
            &nbsp;&nbsp;
            <img src="imagenes/seleccionar.png" border="0" style="cursor:pointer" onclick="calculaResFutbol();">
        </TD>
    </TR>
    <TR>
