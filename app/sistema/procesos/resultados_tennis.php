<?php
	...
	$titulo = 'Cargar Resultados | Tennis';
	$fActual = date("Y-m-d");
...
<TABLE align="left" width="100%" border="0" cellpadding="0" cellspacing="0">
	<TR>
        ...
        <TD width="50%" align="right">
			<?php barra_opciones2('guardarResultadosTennis()', "cambiar_contenido('sistema/procesos/cargar_resultados.php', 'sub_contenido')");?>
		</TD>
	</TR>
</TABLE>
...
<TABLE align="left" width="100%" border="0" cellpadding="2" cellspacing="1" style="border-color:#CCC; border-width:1px; border-style:solid">
	...
	<TR>
		...
		<TD class="objForm">
        	<SELECT id="fecha" onchange="cargarEncuentrosTennis()">
	...
	<TR>
        ...
        <TD class="objForm">
        	<SELECT id="sel_encuentro" onchange="datosEncuentroTennis()">
            	<OPTION value="0">Seleccione..</OPTION>
            </SELECT>
        </TD>
	</TR>
