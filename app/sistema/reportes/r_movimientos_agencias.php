...
<TABLE align="left" width="100%" border="0" cellpadding="0" cellspacing="0">
	<TR>
		<TD width="50%" align="right">
			<?php barra_opciones3("", "imprimir('impresion')", "cambiar_contenido('sistema/reportes/movimientos_agencias.php', 'sub_contenido')");?>
		</TD>
	</TR>
</TABLE>
<BR>
...
<TABLE align="left" width="100%" border="0" cellpadding="1" cellspacing="1">
	<TR>
		<TD class="txtR10" align="center"><strong>Movimientos Registrados en las Agencias</strong></TD>
	</TR>
	<TR>
