<?php
	...
	include_once "../../clases/class.logro_boxeo.php";
...
<TABLE align="left" width="100%" border="0" cellpadding="1" cellspacing="1">
	<THEAD>
    <TR bgcolor="#6FA144">
    	<TD align="center" colspan="2" style="color:#FFFFFF"><strong><?php echo $fLiga[$h]['nombre']; ?></strong></TD>
    </TR>
	<TR bgcolor="#328AA4" height="25">
		<TD width="50%" align="center" style="color: #FFFFFF"><strong>Pelea</strong></TD>
	...
	<TR bgcolor="<?php echo $color;?>" style="cursor:pointer;" onmouseover="fila_sobre(this)" onmouseout="fila_quita(this)">
		<TD align="center" style="color: #000;">
        	<TABLE align="left" border="0" cellpadding="0" cellspacing="0">
            	<TR>
	            	<TD><img width="18" height="18" src="imagenes/logos/boxeo/<?php echo $fObj1[$i]['equipo1']; ?>.png" border="0" onerror="this.src='imagenes/logos/boxeo/logo_error.png';"></TD>
                ...
                <TR>
	            	<TD><img width="18" height="18" src="imagenes/logos/boxeo/<?php echo $fObj1[$i]['equipo2']; ?>.png" border="0" onerror="this.src='imagenes/logos/boxeo/logo_error.png';"></TD>
