<?php
	...
	include_once "../../clases/class.logro_hockey.php";
	...
	<TR bgcolor="<?php echo $color;?>" style="cursor:pointer;" onmouseover="fila_sobre(this)" onmouseout="fila_quita(this)">
		<TD align="center" style="color: #000;">
        	<TABLE align="left" border="0" cellpadding="0" cellspacing="0">
            	<TR>
	            	<TD><img width="20" height="13.33" src="imagenes/logos/hockey/<?php echo $fObj1[$i]['equipo1']; ?>.gif" border="0" onerror="this.src='imagenes/logos/hockey/logo_error.png';"></TD>
                ...
                <TR>
	            	<TD><img width="20" height="13.33" src="imagenes/logos/hockey/<?php echo $fObj1[$i]['equipo2']; ?>.gif" border="0" onerror="this.src='imagenes/logos/hockey/logo_error.png';"></TD>
